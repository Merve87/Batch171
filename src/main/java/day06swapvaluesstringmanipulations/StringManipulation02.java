...
public class StringManipulation02 {
    ...
    public static void main(String[] args) {
        ...
        boolean isEnded =s.endsWith("money");
       ...
       String s1=  s.replace("money", "dollar");
        ...
        //Ornek 3: earn kelimesini win yapin
        ...
        //ornek 4:a harflerini *"a cevirin

        String s3 = s.replace('a','*');
        System.out.println(s3);//Le*rn J*v* e*rn money

        //Ornek5:n harfini xxx yazdirin
        String s4 = s.replace("n", "xxx");
        System.out.println(s4);

        //ornek6:s stringteki "e' harfini siliniz.
        ...
        //ornek7: "t" ile stringteki tum rakamlari "*" a ceviriniz
